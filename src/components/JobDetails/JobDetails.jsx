...
//     const handleApplyButton = (job_title, id, salary, location, remote_or_onsite, job_type, company_logo, company_name, detailsData) =>{
//         console.log(job_title, id);
//     }
...
//                         <button className="btn btn-info mt-10" onClick={()=>handleApplyButton(detailsData.job_title, detailsData.id)}>Apply Now</button>
...
const JobDetails = () => {
    ...
    const handleApplyNowClick = () => {
        // Add your logic to perform the action when "Apply Now" button is clicked
        // For example, you can set the detailsData to local storage
        // let detailsData = getShoppingCart();
        // add quantity
        // const quantity = detailsData[detailsData.id];
        // if (!quantity) {
        //     detailsData[detailsData.id] = 1;
        // }
        // else {
        //     const newQuantity = quantity + 1;
        //     detailsData[detailsData.id] = newQuantity;
        // }
        // localStorage.setItem('jobDetails', JSON.stringify(detailsData));
        // console.log('Job details added to local storage:', detailsData);
                    ...
                    <div>
                        <div className="card w-full h-full  bg-slate-100">
                            <div className="card-body">
                                ...
                                <button className="bg-blue-500 text-white px-4 py-2 mt-4" onClick={handleApplyNowClick}>
                                    Apply Now
                                </button>
                            </div>
                        </div>
